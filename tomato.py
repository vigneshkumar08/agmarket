...
url="https://agmarknet.gov.in/SearchCmmMkt.aspx?Tx_Commodity=78&Tx_State=TN&Tx_District=0&Tx_Market=0&DateFrom=07-Oct-2024&DateTo=07-Nov-2024&Fr_Date=07-Oct-2024&To_Date=07-Nov-2024&Tx_Trend=0&Tx_CommodityHead=Tomato&Tx_StateHead=Tamil+Nadu&Tx_DistrictHead=--Select--&Tx_MarketHead=--Select--"
...
print("Data saved to tomato.csv")
...
try:
    ...
    create_table_query = """
    CREATE TABLE IF NOT EXISTS market_data.tomato_data (
    ...
    for _, row in df.iterrows():
        insert_query = """
        INSERT INTO market_data.tomato_data (district_name, market_name, commodity, variety, grade, min_price, max_price, model_price, price_date)
